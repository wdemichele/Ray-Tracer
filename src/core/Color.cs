...
namespace RayTracer
{
    ...
    public readonly struct Color
    {
        ...
        /// <summary>
        /// Subtract two colors together component-wise.
        /// </summary>
        /// <param name="a">First color structure</param>
        /// <param name="b">Second color structure</param>
        /// <returns>Multiplied color structure</returns>
        ...
        /// <summary>
        /// Multiply a color and a vector together component-wise.
        /// </summary>
        /// <param name="a">First color structure</param>
        /// <param name="b">Second Vector3 structure</param>
        /// <returns>Multiplied color structure</returns>
        public static Color operator *(Color a, Vector3 b)
        {
            return new Color(a.r * b.X, a.g * b.Y, a.b * b.Z);
        }
    }
}
